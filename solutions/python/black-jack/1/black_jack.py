...
def is_blackjack(card_one, card_two):
    ...
    """
    if value_of_card(card_one) == 1 and value_of_card(card_two) == 10 or value_of_card(card_one) == 10 and value_of_card(card_two) == 1:
        return True
    return False
...
def can_double_down(card_one, card_two):
    ...
    """
    if value_of_card(card_one)+value_of_card(card_two)<12 and value_of_card(card_one)+value_of_card(card_two)>8:
        return True
    return False
